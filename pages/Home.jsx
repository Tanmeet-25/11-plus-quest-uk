...
export default function App() {
    ...
    <PageWrap>
      ...
      {!user&&(
        <div style={{background:"rgba(255,255,255,0.1)",borderRadius:16,padding:"16px",marginTop:12,textAlign:"center"}}>
          ...
          <a href="/login" style={{display:"inline-block",padding:"10px 24px",borderRadius:12,background:"white",color:"#3730a3",fontWeight:800,fontSize:14,textDecoration:"none"}}>Sign In / Register →</a>
        </div>
      )}
      {user&&(
    ...
    if (!user) return (
      <PageWrap>
        <div style={{textAlign:"center",padding:"60px 20px"}}>
          ...
          <a href="/login" style={{display:"inline-block",padding:"12px 28px",borderRadius:14,background:"white",color:"#3730a3",fontWeight:800,fontSize:15,textDecoration:"none"}}>Sign In / Register →</a>
        </div>
      </PageWrap>
    );
  ...
  if (tab==="leaderboard") return (
    <PageWrap>
      ...
      {!user&&<div style={{background:"rgba(255,255,255,0.1)",borderRadius:14,padding:"14px",marginTop:12,textAlign:"center"}}><p style={{color:"white",fontWeight:700,fontSize:13,margin:"0 0 8px"}}>Sign in to appear on the leaderboard!</p><a href="/login" style={{display:"inline-block",padding:"9px 20px",borderRadius:10,background:"white",color:"#3730a3",fontWeight:800,fontSize:13,textDecoration:"none"}}>Sign In →</a></div>}
    </PageWrap>
  );
