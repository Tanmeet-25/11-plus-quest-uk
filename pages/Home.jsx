...
const WORLDS=[
  ...
  // ───────────────── TODDLER extras (worlds 3–7) ──────────────────────────
  {id:"t_counting2", ageGroup:"toddler", free:true,
   name:"Number Pond",       icon:"🐸",colour:"#6EE7B7",gradient:"linear-gradient(135deg,#6EE7B7,#10B981)",
   desc:"Count objects, spot more/fewer and order numbers!",
   missions:[
    {id:"tp_count",  name:"How Many?",       icon:"🔢",topic:"Toddler Counting",  xp:20,coins:5,questions:5,friendly:true},
    {id:"tp_more",   name:"More or Fewer?",  icon:"⚖️",topic:"Toddler More Less", xp:20,coins:5,questions:5,friendly:true},
    {id:"tp_order",  name:"1, 2, 3 Order!",  icon:"📊",topic:"Toddler Order",     xp:25,coins:6,questions:5,friendly:true},
    {id:"tp_col2",   name:"Colour Match",    icon:"🎨",topic:"Toddler Colours",   xp:20,coins:5,questions:5,friendly:true},
    {id:"tp_boss",   name:"⭐ Pond Star",     icon:"🌟",topic:"Toddler BOSS",      xp:80,coins:20,questions:5,isBoss:true,friendly:true},
   ]},
  {id:"t_letters",   ageGroup:"toddler", free:true,
   name:"ABC Island",        icon:"🔤",colour:"#A78BFA",gradient:"linear-gradient(135deg,#A78BFA,#7C3AED)",
   desc:"Recognise letters, sounds and simple words!",
   missions:[
    {id:"tl_abc",    name:"ABC Fun",         icon:"🔤",topic:"Toddler Letters",   xp:20,coins:5,questions:5,friendly:true},
    {id:"tl_sound",  name:"What Sound?",     icon:"🎵",topic:"Toddler Sounds",    xp:22,coins:5,questions:5,friendly:true},
    {id:"tl_word",   name:"First Words",     icon:"📖",topic:"Toddler Words",     xp:25,coins:6,questions:5,friendly:true},
    {id:"tl_anim2",  name:"Animal Match",    icon:"🐾",topic:"Toddler Animals",   xp:20,coins:5,questions:5,friendly:true},
    {id:"tl_boss",   name:"⭐ Island Star",   icon:"🌟",topic:"Toddler BOSS",      xp:80,coins:20,questions:5,isBoss:true,friendly:true},
   ]},
  {id:"t_body",      ageGroup:"toddler", free:true,
   name:"Body World",        icon:"🧍",colour:"#FCA5A5",gradient:"linear-gradient(135deg,#FCA5A5,#F87171)",
   desc:"Body parts, feelings and the world around us!",
   missions:[
    {id:"tb_body",   name:"Body Parts",      icon:"🦷",topic:"Toddler Body",      xp:20,coins:5,questions:5,friendly:true},
    {id:"tb_feel",   name:"How Do You Feel?",icon:"😊",topic:"Toddler Feelings",  xp:20,coins:5,questions:5,friendly:true},
    {id:"tb_size2",  name:"Big & Tiny",      icon:"📏",topic:"Toddler Size",      xp:22,coins:5,questions:5,friendly:true},
    {id:"tb_pat2",   name:"Pattern Magic",   icon:"🔄",topic:"Toddler Patterns",  xp:22,coins:5,questions:5,friendly:true},
    {id:"tb_boss",   name:"⭐ Body Star",     icon:"🌟",topic:"Toddler BOSS",      xp:80,coins:20,questions:5,isBoss:true,friendly:true},
   ]},
  {id:"t_world",     ageGroup:"toddler", free:true,
   name:"My World",          icon:"🌍",colour:"#FDE68A",gradient:"linear-gradient(135deg,#FDE68A,#F59E0B)",
   desc:"Food, weather, transport and everyday things!",
   missions:[
    {id:"tw_food",   name:"Yummy Food!",     icon:"🍎",topic:"Toddler Food",      xp:20,coins:5,questions:5,friendly:true},
    {id:"tw_weath",  name:"Sunny or Rainy?", icon:"🌤️",topic:"Toddler Weather",   xp:20,coins:5,questions:5,friendly:true},
    {id:"tw_transp", name:"Let's Travel!",   icon:"🚗",topic:"Toddler Transport", xp:22,coins:5,questions:5,friendly:true},
    {id:"tw_count2", name:"Count Again!",    icon:"🔢",topic:"Toddler Counting",  xp:20,coins:5,questions:5,friendly:true},
    {id:"tw_boss",   name:"⭐ World Star",    icon:"🌟",topic:"Toddler BOSS",      xp:80,coins:20,questions:5,isBoss:true,friendly:true},
   ]},
  {id:"t_time",      ageGroup:"toddler", free:true,
   name:"Time Tower",        icon:"🕐",colour:"#BAE6FD",gradient:"linear-gradient(135deg,#BAE6FD,#38BDF8)",
   desc:"Days, seasons and simple time concepts!",
   missions:[
    {id:"tt_days",   name:"Days of Week",    icon:"📅",topic:"Toddler Days",      xp:22,coins:6,questions:5,friendly:true},
    {id:"tt_seas",   name:"Seasons Fun",     icon:"🍂",topic:"Toddler Seasons",   xp:22,coins:6,questions:5,friendly:true},
    {id:"tt_shape2", name:"Shape Again!",    icon:"🔷",topic:"Toddler Shapes",    xp:20,coins:5,questions:5,friendly:true},
    {id:"tt_col3",   name:"Rainbow Match",   icon:"🌈",topic:"Toddler Colours",   xp:20,coins:5,questions:5,friendly:true},
    {id:"tt_boss",   name:"⭐ Time Star",     icon:"🌟",topic:"Toddler BOSS",      xp:80,coins:20,questions:5,isBoss:true,friendly:true},
   ]},

  // ───────────────── EARLY extras (worlds 4–7) ────────────────────────────
  {id:"e_telling_time", ageGroup:"early",
   name:"Clock Castle",      icon:"🕐",colour:"#FB923C",gradient:"linear-gradient(135deg,#FB923C,#EA580C)",
   desc:"O'clock, half past and simple time!",
   missions:[
    {id:"ec_oclock", name:"O'Clock Fun",     icon:"🕐",topic:"Early Time",        xp:30,coins:7,questions:5,friendly:true},
    {id:"ec_half",   name:"Half Past!",      icon:"🕧",topic:"Early Time",        xp:33,coins:7,questions:5,friendly:true},
    {id:"ec_ord",    name:"1st, 2nd, 3rd",   icon:"🥇",topic:"Early Ordinals",    xp:33,coins:7,questions:5,friendly:true},
    {id:"ec_count2", name:"Count to 50",     icon:"🔢",topic:"Early Counting",    xp:30,coins:7,questions:5,friendly:true},
    {id:"ec_boss",   name:"⭐ Clock Star",    icon:"⏰",topic:"Early BOSS",        xp:100,coins:25,questions:6,isBoss:true,friendly:true},
   ]},
  {id:"e_money",     ageGroup:"early",
   name:"Money Market",      icon:"🪙",colour:"#D97706",gradient:"linear-gradient(135deg,#D97706,#B45309)",
   desc:"Recognise coins, count money and add prices!",
   missions:[
    {id:"em_coins",  name:"Coin Spotters",   icon:"🪙",topic:"Early Money",       xp:32,coins:8,questions:5,friendly:true},
    {id:"em_add",    name:"Adding Prices",   icon:"💷",topic:"Early Money",       xp:35,coins:8,questions:5,friendly:true},
    {id:"em_sub",    name:"Change Please!",  icon:"💰",topic:"Early Subtraction", xp:35,coins:8,questions:5,friendly:true},
    {id:"em_mul",    name:"Times It!",       icon:"✖️",topic:"Early Multiplication",xp:38,coins:9,questions:5,friendly:true},
    {id:"em_boss",   name:"⭐ Market Star",   icon:"💎",topic:"Early BOSS",        xp:100,coins:25,questions:6,isBoss:true,friendly:true},
   ]},
  {id:"e_science",   ageGroup:"early",
   name:"Science Lab",       icon:"🔬",colour:"#10B981",gradient:"linear-gradient(135deg,#10B981,#047857)",
   desc:"Living things, materials and senses!",
   missions:[
    {id:"es_liv",    name:"Living Things",   icon:"🌱",topic:"Early Science",     xp:30,coins:7,questions:5,friendly:true},
    {id:"es_mat",    name:"Materials",       icon:"🪨",topic:"Early Materials",   xp:33,coins:7,questions:5,friendly:true},
    {id:"es_sens",   name:"5 Senses",        icon:"👁️",topic:"Early Senses",      xp:33,coins:7,questions:5,friendly:true},
    {id:"es_spell2", name:"Spell More!",     icon:"✍️",topic:"Early Spelling",    xp:35,coins:8,questions:5,friendly:true},
    {id:"es_boss",   name:"⭐ Lab Star",      icon:"⚗️",topic:"Early BOSS",        xp:100,coins:25,questions:6,isBoss:true,friendly:true},
   ]},
  {id:"e_world",     ageGroup:"early",
   name:"World Explorer",    icon:"🌍",colour:"#6366F1",gradient:"linear-gradient(135deg,#6366F1,#4F46E5)",
   desc:"Countries, continents and capital cities!",
   missions:[
    {id:"ew_cont",   name:"Continents",      icon:"🗺️",topic:"Early Geography",   xp:32,coins:7,questions:5,friendly:true},
    {id:"ew_count",  name:"Countries",       icon:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",topic:"Early Countries",   xp:33,coins:7,questions:5,friendly:true},
    {id:"ew_weath",  name:"World Weather",   icon:"☁️",topic:"Early Weather",      xp:33,coins:7,questions:5,friendly:true},
    {id:"ew_words2", name:"More First Words",icon:"📖",topic:"Early Words",       xp:30,coins:7,questions:5,friendly:true},
    {id:"ew_boss",   name:"⭐ Explorer Star", icon:"🧭",topic:"Early BOSS",        xp:100,coins:25,questions:6,isBoss:true,friendly:true},
   ]},

  // ───────────────── JUNIOR extras (worlds 4–7) ───────────────────────────
  {id:"j_fractions", ageGroup:"junior",
   name:"Fraction Falls",    icon:"½",colour:"#F59E0B",gradient:"linear-gradient(135deg,#F59E0B,#D97706)",
   desc:"Fractions, decimals and simple percentages",
   missions:[
    {id:"jf_half",   name:"Halves & Quarters",icon:"¼",topic:"Junior Fractions", xp:50,coins:10,questions:6},
    {id:"jf_dec",    name:"Decimal Dunes",    icon:"0.5",topic:"Junior Decimals",xp:55,coins:11,questions:6},
    {id:"jf_pct",    name:"Percent Peaks",    icon:"％",topic:"Junior Percentages",xp:55,coins:11,questions:6},
    {id:"jf_mix",    name:"Mix It Up!",       icon:"🔀",topic:"Fractions",       xp:60,coins:12,questions:6},
    {id:"jf_boss",   name:"⚔️ Falls Boss",    icon:"🌊",topic:"BOSS",            xp:150,coins:40,questions:8,isBoss:true},
   ]},
  {id:"j_data",      ageGroup:"junior",
   name:"Data Desert",       icon:"📊",colour:"#EF4444",gradient:"linear-gradient(135deg,#EF4444,#DC2626)",
   desc:"Charts, graphs, tables and basic statistics",
   missions:[
    {id:"jd_bar",    name:"Bar Chart Bay",    icon:"📊",topic:"Statistics",      xp:45,coins:9,questions:6},
    {id:"jd_pic",    name:"Pictogram Plains", icon:"🖼️",topic:"Statistics",      xp:45,coins:9,questions:6},
    {id:"jd_tab",    name:"Table Town",       icon:"📋",topic:"Statistics",      xp:50,coins:10,questions:6},
    {id:"jd_avg",    name:"Average Arena",    icon:"⚖️",topic:"Statistics",      xp:55,coins:11,questions:6},
    {id:"jd_boss",   name:"⚔️ Desert Boss",   icon:"🦂",topic:"BOSS",            xp:150,coins:40,questions:8,isBoss:true},
   ]},
  {id:"j_verbal",    ageGroup:"junior",
   name:"Word Jungle",       icon:"💬",colour:"#D97706",gradient:"linear-gradient(135deg,#D97706,#92400E)",
   desc:"Synonyms, antonyms, word families and analogies",
   missions:[
    {id:"jv_syn",    name:"Synonym Swamp",    icon:"🔄",topic:"Synonyms & Antonyms",xp:45,coins:9,questions:6},
    {id:"jv_ant",    name:"Antonym Atoll",    icon:"↔️",topic:"Synonyms & Antonyms",xp:45,coins:9,questions:6},
    {id:"jv_fam",    name:"Word Families",    icon:"👨‍👩‍👧",topic:"Vocabulary",       xp:50,coins:10,questions:6},
    {id:"jv_ana",    name:"Analogy Alcove",   icon:"🔗",topic:"Analogies",       xp:55,coins:11,questions:6},
    {id:"jv_boss",   name:"⚔️ Jungle Boss",   icon:"🐊",topic:"BOSS",            xp:150,coins:40,questions:8,isBoss:true},
   ]},
  {id:"j_science",   ageGroup:"junior",
   name:"Science Station",   icon:"⚗️",colour:"#6D28D9",gradient:"linear-gradient(135deg,#6D28D9,#4C1D95)",
   desc:"Forces, materials, living things and the environment",
   missions:[
    {id:"jsc_for",   name:"Forces Field",     icon:"⚡",topic:"Junior Science",  xp:45,coins:9,questions:6},
    {id:"jsc_mat",   name:"Materials Mine",   icon:"🪨",topic:"Junior Science",  xp:45,coins:9,questions:6},
    {id:"jsc_liv",   name:"Life Station",     icon:"🌱",topic:"Junior Science",  xp:50,coins:10,questions:6},
    {id:"jsc_env",   name:"Eco Enclave",      icon:"🌍",topic:"Junior Science",  xp:50,coins:10,questions:6},
    {id:"jsc_boss",  name:"⚔️ Station Boss",  icon:"🤖",topic:"BOSS",            xp:150,coins:40,questions:8,isBoss:true},
   ]},

  // ───────────────── ADVANCED extras (worlds 5–7) ─────────────────────────
  {id:"adv_nvr",     ageGroup:"advanced",
   name:"Pattern Palace",    icon:"🔲",colour:"#DC2626",gradient:"linear-gradient(135deg,#DC2626,#7F1D1D)",
   desc:"Advanced non-verbal reasoning — matrices & 3D",
   missions:[
    {id:"an_mat",    name:"Matrix Mansion",   icon:"🔲",topic:"Patterns & Matrices",xp:120,coins:22,questions:6},
    {id:"an_3d",     name:"3D Dungeon",       icon:"🧊",topic:"3D Shapes",         xp:120,coins:22,questions:6},
    {id:"an_fold",   name:"Net Forge",        icon:"📦",topic:"Patterns & Matrices",xp:130,coins:24,questions:6},
    {id:"an_sym",    name:"Symmetry Sanctum", icon:"🔄",topic:"Symmetry & Reflection",xp:120,coins:22,questions:6},
    {id:"an_boss",   name:"⚔️ Palace Boss",   icon:"🧿",topic:"BOSS",              xp:350,coins:80,questions:8,isBoss:true},
   ]},
  {id:"adv_english",  ageGroup:"advanced",
   name:"Literature Lair",   icon:"📚",colour:"#059669",gradient:"linear-gradient(135deg,#059669,#064E3B)",
   desc:"Advanced comprehension, rhetoric and essay skills",
   missions:[
    {id:"ae_comp",   name:"Comprehension Cave",icon:"👓",topic:"Literary Devices", xp:120,coins:22,questions:6},
    {id:"ae_rhet",   name:"Rhetoric Ridge",   icon:"🗣️",topic:"Vocabulary",        xp:120,coins:22,questions:6},
    {id:"ae_punc",   name:"Punctuation Peak", icon:"✏️",topic:"Punctuation",       xp:120,coins:22,questions:6},
    {id:"ae_gram2",  name:"Grammar Grotto",   icon:"📝",topic:"Grammar",           xp:130,coins:24,questions:6},
    {id:"ae_boss",   name:"⚔️ Lair Boss",     icon:"🐉",topic:"BOSS",              xp:350,coins:80,questions:8,isBoss:true},
   ]},
  {id:"adv_seq",     ageGroup:"advanced",
   name:"Sequence Summit",   icon:"🔢",colour:"#0EA5E9",gradient:"linear-gradient(135deg,#0EA5E9,#0C4A6E)",
   desc:"Number sequences, series and logical patterns",
   missions:[
    {id:"as_arith",  name:"Arithmetic Ascent",icon:"📈",topic:"Sequences",         xp:120,coins:22,questions:6},
    {id:"as_geom",   name:"Geometric Gorge",  icon:"🔺",topic:"Sequences",         xp:130,coins:24,questions:6},
    {id:"as_let",    name:"Letter Labyrinth", icon:"🔡",topic:"Codes & Ciphers",   xp:120,coins:22,questions:6},
    {id:"as_logic",  name:"Logic Lock",       icon:"🔒",topic:"Analogies",         xp:130,coins:24,questions:6},
    {id:"as_boss",   name:"⚔️ Summit Boss",   icon:"🦅",topic:"BOSS",              xp:350,coins:80,questions:8,isBoss:true},
   ]},
];
...
export default function App(){
  ...
  // ── ONBOARDING GATE: require age group selection ─────────────────────────────
